#Takes a photo when a thums up is detected -- does this by just freezing the last detected body frame at that moment
# wHEN NO ONE IS DETECTED IN THE FRAME NYMORE, CLEAR THE FRAME and show what is naturally there
